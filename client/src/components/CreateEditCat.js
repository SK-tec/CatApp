      ...
      <div className="w-1/2 bg-blue-300 rounded shadow-2xl p-8 m-2">
        ...
        <form onSubmit={handleSubmit}>
          <div className="flex flex-col mb-4">
            <label className="mb-2 font-bold text-lg text-gray-900" for="breed">
              Breed
            </label>
            <input
          ...
          <div className="flex flex-col mb-4">
            ...
            <input
              ...
              type="text"
              name="temperament"
              value={id && cat.temperament}
              id="temperament"
            />
          </div>
          <div className="flex flex-col mb-4">
            <label className="mb-2 font-bold text-lg text-gray-900" for="url">
              Cat Image URL
            </label>
            <input
              className="border py-2 px-3 text-grey-800"
